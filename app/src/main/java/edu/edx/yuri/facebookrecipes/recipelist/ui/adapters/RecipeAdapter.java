...
public class RecipeAdapter extends RecyclerView.Adapter<RecipeAdapter.ViewHolder> {
    ...
    public RecipeAdapter(List<Recipe> recipeList, ImageLoader imageLoader, OnItemClickListener onItemClickListener) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setOnItemClickListener(final Recipe currentRecipe, final OnItemClickListener onItemClickListener) {
            ...
            imgFav.setOnClickListener(new View.OnClickListener(){
                @Override
                public void onClick(View view) {
                    onItemClickListener.onFavoriteClick(currentRecipe);
                }
            });
            ...
            ShareLinkContent content = new ShareLinkContent
                    .Builder().setContentUrl(Uri.parse(currentRecipe.getSourceURL()))
                    .build();
